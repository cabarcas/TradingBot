# Strategy component should now be mixed with Strategy module. the first only has to do with the interface
# triggering methods to help the user to input parameters and activate or delete a strategy. It doesn't have to do
# with the strategy logic.
...
class StrategyEditor(tk.Frame):
    ...
    # activate or deactivate the strategy while checks at activation for missing parameters
